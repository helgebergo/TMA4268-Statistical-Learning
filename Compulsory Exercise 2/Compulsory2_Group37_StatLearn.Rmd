...
svm.linear.best = svm.linear$best.model
# summary(svm.linear.best)

svm.linear.pred  = predict(svm.linear.best,d.test)
...
svm.radial.best = svm.radial$best.model
# summary(svm.radial.best)

svm.radial.pred  = predict(svm.radial.best,d.test)
