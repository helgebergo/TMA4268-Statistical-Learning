...
The degrees of freedom was chosen using cross-validation, and the result was `r fit.smoothspline$df`. 
...
The MSE for the polynomial 

MSE is `r sprintf("%.0f",MSE.smoothspline.train )` for the train set, and `r sprintf("%.0f",MSE.smoothspline.test)` for the
